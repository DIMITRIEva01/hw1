...
<head>
    ...
    <script src='onClicklogout.js' defer></script>
    <script src='carica_modale.js' defer></script>
...
<body data-userid="<?php echo $userid; ?>">
    ...
    <section class="articoli" id="manga-container">
        
    </section>
    <div class="scorrimento">
        <button id="btn_left"> 
        </button>
        <button id="btn_center" >   
        </button> 
        <button id="btn_right" >
        </button>
    </div>
...
<div class="container">
    ...
    <section class="articoli" id="manga-container2">
        
    </section>
    <div class="scorrimento">
        <button id="btn_left2"> 
        </button>
        <button id="btn_center2" >   
        </button> 
        <button id="btn_right2">
        </button>
    </div>
</div>
<div class="container">
    <section class="testo">
        <h2>CON VALUTAZIONE PIù ALTA</h2>
    </section>
    <section class="articoli" id="manga-container3">
        
    </section>
    <div class="scorrimento">
        <button id="btn_left3"> 
        </button>
        <button id="btn_center3" >   
        </button> 
        <button id="btn_right3">
        </button>
    </div>
</div>
    ...
    <div id="modale1" class="modale1">
            ...
            <div id="modale2" class="modale2">
                ...
                <span id="close-modal2">&times;</span>
                    <h2 id="carrello21">Carrello</h2>
                        <div id="carrello-content">
                        
                        <p class="caricamento"> </p>
                    </div>
                </div>
            </div>
            ...
            <div id="modale-menu" class="modale-menu">
                ...
                <span id="close-modal-menu">&times;</span>
                    ...
                    <button id="accedi-mobile"><?php echo htmlspecialchars($username); ?></button>
